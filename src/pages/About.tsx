        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => <div key={index} className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                <div className="rounded-full overflow-hidden w-40 h-40 mx-auto mb-4">
                  <img src="/lovable-uploads/307c73c0-2130-4990-a54c-b28831a9dff7.png" alt="Nabeel" className="w-full h-full object-cover" />
                </div>
              ...
              <div className="text-center">
                <div className="rounded-full overflow-hidden w-40 h-40 mx-auto mb-4">
                  <img src="/lovable-uploads/b5b3ad36-46ae-4730-93d7-015bb34c7d8f.png" alt="Henrick" className="w-full h-full object-cover" />
                </div>
                <h3 className="text-lg font-medium">Nabeel</h3>
                <p className="text-orange-600">Founder & CEO</p>
                <p className="text-gray-500 mt-2">Founder and visionary focused on company strategy and chef relations. I</p>
              </div>
            </div>
          </div>
