    ...
    <div className="relative bg-[#F97316] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="relative z-10 pb-8 bg-[#F97316] sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <div className="flex flex-col justify-center min-h-[calc(100vh-6rem)] gap-8 px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center lg:items-start gap-6">
              <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                <span className="block">Global Flavors for Your Workplace</span>
              </h1>
              <p className="text-base text-white/90 sm:text-lg sm:max-w-xl md:text-xl">
